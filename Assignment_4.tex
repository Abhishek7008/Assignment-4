...
\begin{lstlisting}
https://github.com/Abhishek7008/Assignment-4.git
\end{lstlisting}
%
...
\begin{align}
    ...
    \end{align}
 So reduction of the  $2\times3$   matrix\\
 \begin{align}
     \myvec{3&2&5\\2&-3&7}
 \end{align}
 results in a matrix with 2 nonzero row, its
rank is 2. Similarly, the rank of the matrix\\
   \begin{align}
       \myvec{3&2\\2&-3}
   \end{align} 
    is also 2.\\
